      ...
      >
        <View style={styles.iconContainer}>
          <View style={styles.iconWrapper}>
            <IconSymbol name="book.closed" size={60} color="white" />
          </View>
        </View>

        <Text style={styles.title}>Research & Publications</Text>
        <Text style={styles.subtitle}>Advancing neurological sciences</Text>

        <View style={styles.contentCard}>
          <View style={styles.statusBadge}>
            <IconSymbol name="clock" size={16} color="#34C759" />
          ...
          <Text style={styles.message}>
            ...
            {'\n\n'}
            Advancing the field through rigorous research and knowledge sharing.
          </Text>
        </View>
